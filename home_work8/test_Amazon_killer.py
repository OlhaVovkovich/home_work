...
from amazon_killer import amazon_killer as app, USERS_DATABASE, CARTS_DATABASE
...
@patch.dict(USERS_DATABASE, {}, clear=True)
...
@patch.dict(CARTS_DATABASE, {}, clear=True)
